...
The questions domain is paused right now. Guided workflows should use Pi's normal chat/input prompts until the question tool gets future design and reliability work.
