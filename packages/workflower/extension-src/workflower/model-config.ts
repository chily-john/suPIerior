...
export function validateConfig(config: unknown): ValidationResult {
  ...
  if (cfg.modelLevels !== undefined) {
    if (typeof cfg.modelLevels !== 'object' || cfg.modelLevels === null || Array.isArray(cfg.modelLevels)) {
  ...
  if (cfg.fallbackStrategy !== undefined) {
    ...
    } else if (!VALID_FALLBACK_STRATEGIES.includes(cfg.fallbackStrategy as typeof VALID_FALLBACK_STRATEGIES[number])) {
