...
export function buildMaintainerPrompt(changedFiles: string[], reason: string, protectedRulePaths: string[] = [], metadata: MaintainerPathChangeMetadata = {}): string {
