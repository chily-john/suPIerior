...
describe("validate-exports script", () => {
  ...
  describe("Red Phase - Export name validation", () => {
    it("should fail when index.ts exports wrong component name", () => {
      ...
      writeFileSync(
        ...
        'export { WrongExport as DifferentName } from "./Component";',
      );
    ...
    it("should pass when index.ts exports correct component name", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const CorrectExport = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { CorrectExport } from "./Component";',
      );
  ...
  describe("Parts directory validation", () => {
    it("should check that all part files are exported from parts/index.ts", () => {
      ...
      writeFileSync(
        resolve(componentPath, "parts", "Footer.tsx"),
        "export const Footer = () => null;",
      );

      // Create parts/index.ts
      writeFileSync(
        resolve(componentPath, "parts", "index.ts"),
        `
  ...
  describe("Glob pattern support", () => {
    it("should validate all index.ts files with glob pattern", () => {
      ...
      writeFileSync(
        resolve(invalidPath, "Component.tsx"),
        "export const InvalidComp = () => null;",
      );
      writeFileSync(
        resolve(invalidPath, "index.ts"),
        'export { InvalidComp as WrongName } from "./Component";',
      );
  ...
  describe("Component name derivation", () => {
    it("should derive expected component name from directory name", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const DirectoryName = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { DirectoryName } from "./Component";',
      );
