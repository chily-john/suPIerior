...
describe("validate-component-structure script", () => {
  ...
  describe("Basic validation", () => {
    ...
    it("should accept path as positional argument", () => {
      ...
      mkdirSync(componentPath, { recursive: true });
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const PositionalArg = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { PositionalArg } from "./Component";',
      );
    ...
    it("should fail when component is missing index.ts", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const MissingIndex = () => null;",
      );
    ...
    it("should pass when component has all required files", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const ValidComponent = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { ValidComponent } from "./Component";',
      );
    ...
    it("should output JSON when --json flag is used", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const JsonOutput = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { JsonOutput } from "./Component";',
      );
  ...
  describe("Options", () => {
    ...
    it("should require component.types.ts when --requireTypes is true", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const RequireTypes = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { RequireTypes } from "./Component";',
      );
    ...
    it("should require parts directory when --requireParts is true", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const RequireParts = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { RequireParts } from "./Component";',
      );
  ...
  describe("Parts directory validation", () => {
    ...
    it("should warn when parts directory is empty", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const EmptyParts = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { EmptyParts } from "./Component";',
      );
    ...
    it("should warn when parts directory is missing index.ts", () => {
      ...
      writeFileSync(
        resolve(componentPath, "Component.tsx"),
        "export const PartsNoIndex = () => null;",
      );
      writeFileSync(
        resolve(componentPath, "index.ts"),
        'export { PartsNoIndex } from "./Component";',
      );
      writeFileSync(
        resolve(componentPath, "parts", "Header.tsx"),
