...
Enter here when adding or updating tests for feature-flow behavior. Current coverage focuses on domain helpers, discovery model parsing/repair, and the workflow's artifact-writing lifecycle.
