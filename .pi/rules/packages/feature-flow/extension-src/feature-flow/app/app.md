...
- During discovery, rebase the `QuestionQueue` from each model response and route busy/rendering/input-ready transitions through the shared `FeatureFlowStateController`.
