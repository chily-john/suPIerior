...
- Use `beginQuestionLoading` for model-thinking pauses that should clear editor text, show the working indicator/message, and temporarily consume terminal input.
