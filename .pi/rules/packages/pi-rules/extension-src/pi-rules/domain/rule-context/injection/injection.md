...
kind: rules
paths:
  - 'packages/pi-rules/extension-src/pi-rules/domain/rule-context/injection/**/*'
...
- Respect configured full-rule character limits and make truncation explicit in injected text.
